    ...
    <div className='max-w-4xl mx-auto'>
        <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none'>
            ...
            components={{
                ...
                h4({children}){
                    return <h4 className='text-basse font-bold mt-4 mb-2'>{children}</h4>;
                },
                a({children,href}){
...
function CodeBlock({code,language}){
    ...
    return <div className='relative my-6 rouded-lg overflow-hidden bg-gray-50 border border-gray-200'>
        <div className='flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200'>
            ...
            <button onClick={copyCode} className='text-gray-500 hover:gray-700 focus:outline-none relative group' aria-label='Copy Code'>

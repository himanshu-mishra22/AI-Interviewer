...
const RoleInfoHeader = ({
  ...
  return <div className="bg-white relative">  
    <div className="container mx-auto px-10 md:px-0">
        <div className="h-[200px] p-6 flex flex-col justify-center relative z-10">
            ...
            <div className="flex items-center gap-3 mt-4">
                <div className="text-[10px] text-white font-semibold bg-black px-3 py-1 rounded-full"> 
                ...
                <div className="text-[10px] fonot-semibold text-white bg-black px-3 py-1 rounded-full">
